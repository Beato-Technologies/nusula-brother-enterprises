          ...
          <div className="contact-wrapper-2">
            <div className="row g-4 align-items-center">
              <div className="col-lg-6">
                ...
                {/* Tanzania Operations */}
                <div className="contact-left-items mt-4">
                  <div className="contact-info-area-2">
                    <div className="contact-info-items mb-4">
                      <div className="icon">
                        <svg width={30} height={30} viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div className="contact-info-items mb-4">
                      ...
                      <div className="content">
                        <p>Email Us</p>
                        <h3 className='text-lowercase'>
                          <Link href="mailto:tz@nusulabrotherenterprises.com">tz@nusulabrotherenterprises.com</Link>
                        </h3>
                      </div>
                    </div>
                    <div className="contact-info-items border-none">
                      ...
                      <div className="content">
                        ...
                        <h3>
                          Plot 16, Chango&apos;mbe Area, Dar es Salaam
                        </h3>
                      </div>
                    </div>
                  </div>
